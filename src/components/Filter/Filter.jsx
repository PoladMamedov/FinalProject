      ...
      <div className="filter-section">
        <div className="filter-section-full" ref={ref}>
          ...
          <svg
            ...
            className="filter-section-btn-close"
            width={25}
            height={25}
          ...
          <div className="filter-section-container">
                ...
                .map((item) => (
                  <div key={item.name} className="filter-section-list__item">
                    ...
                    <input
                      ...
                      className="filter-section-list__item-checkbox"
                    ></input>
                  </div>
                ))}
            </form>
            ...
            <button type="button" className="filter-section-btn filter-section-btn--dark">
              Set Price
            </button>
            <div className="filter-section-btn-container">
              <button type="button" onClick={resetBtnClick} className="filter-section-btn filter-section-btn--light">
                Clear Filter
              </button>
              <button type="button" className="filter-section-btn filter-section-btn--dark filter-section-btn--apply">
                Apply
              </button>
            </div>
          </div>
